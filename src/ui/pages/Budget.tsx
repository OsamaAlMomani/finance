      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {budgets.length === 0 && (
            <div className="col-span-2 text-center py-12 text-gray-400 border-2 border-dashed border-gray-300 rounded-xl">
                <p className="text-xl font-hand">No budgets set yet. Start saving!</p>
            </div>
        )}
      </div>
        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-xl shadow-xl w-full max-w-sm border-2 border-gray-200">
                ...
                <form onSubmit={handleSave} className="space-y-4">
                    ...
                    <div>
                        <label htmlFor="budget-period" className="block text-sm font-bold mb-1">Period</label>
                         <select 
                          id="budget-period"
                            className="w-full p-2 border rounded font-hand text-lg"
                    ...
                    <div>
                        <label htmlFor="budget-limit" className="block text-sm font-bold mb-1">Limit Amount</label>
                        <input 
                          id="budget-limit"
